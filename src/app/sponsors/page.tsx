        ...
        >
          <div className="relative flex flex-col w-full py-16 items-center mb-8">
            ...
            <img
              ...
              className="min-w-[250px] max-h-[250px] max-w-[400px] hover:saturate-150 hover:brightness-150 p-8 bg-[radial-gradient(hsl(var(--background),1),hsl(var(--background),0.5),#fff0,#fff0)] transition-all"
